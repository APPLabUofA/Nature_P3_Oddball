...
ylabel('Electrode');xlabel('Time (ms)'); title('T-test of Difference Waves (Nature - Urban)');set(gca, 'YDir','reverse');ylim([2,32]);xlim([-200,1000]);
...
ylabel('Electrode');xlabel('Time (ms)'); title('T-test of Difference Waves (Nature - Urban)'); set(gca, 'YDir','reverse'); ylim([2,32]);xlim([-200,1000]);hold off;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
